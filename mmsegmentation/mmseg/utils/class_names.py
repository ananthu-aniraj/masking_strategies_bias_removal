...
def cub_binary_seg_classes():
    """CUB binary seg class names for external use."""
    return [
        'background', 'bird'
    ]


def cub_binary_seg_palette():
    """CUB binary seg palette for external use."""
