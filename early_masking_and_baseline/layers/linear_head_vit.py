...
def linear_head_vit_dino(backbone: nn.Module, embed_dim: int, num_classes: int, patch_tokens_only: bool = False, class_token_only: bool = False):
    ...
    return _LinearClassifierViT(backbone=backbone, linear_head=linear_head, patch_tokens_only=patch_tokens_only, class_token_only=class_token_only)
